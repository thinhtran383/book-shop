...
const Header: React.FC = () => {
    const menuItems = [
        { label: 'Features 1', onClick: () => console.log('Features 1') },
        { label: 'Features 2', onClick: () => console.log('Features 2') },
        { label: 'Features 3', onClick: () => console.log('Features 3') },
    ];
    ...
    return (
        <>
            ...
            >
                ...
                >
                    <Button variant="plain" className={styles.button}>
                        Features
                    </Button>
